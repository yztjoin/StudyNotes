...
![image-20220127223017075](F:\计算机网络\assets\image-20220127223017075.png)
...
![image-20220127230659441](F:\计算机网络\assets\image-20220127230659441.png)
...
- 由一些对象组成
- 对象可以是HTML文件、JPEG图片、Java小程序、声音剪辑文件等
- web有一个基本的HTML文件，该基本的HTML文件又包含多干个对象的引用
- 通过URL对每个对象进行引用：用户名、口令字、端口

>![image-20220321202656922](F:\计算机网络\assets\image-20220321202656922.png)
...
![image-20220327150815263](F:\计算机网络\assets\image-20220327150815263.png)

![image-20220327153043528](F:\计算机网络\assets\image-20220327153043528.png)
...
![image-20220327184123027](F:\计算机网络\assets\image-20220327184123027.png)
